...
public class ClassTest extends AbstractCustomStatementTest {
  ...
  public void testEmptyClass() {
    ...
    assertThat(classStatement.canonicalName()).isEqualTo("intellispaces.common.javastatement.samples.EmptyClass");
    assertThat(classStatement.className()).isEqualTo("intellispaces.common.javastatement.samples.EmptyClass");
  ...
  public void testNestedClass() {
    ...
    assertThat(classStatement.canonicalName()).isEqualTo("intellispaces.common.javastatement.samples.NestedClass.NestedClass1.NestedClass2");
    assertThat(classStatement.className()).isEqualTo("intellispaces.common.javastatement.samples.NestedClass$NestedClass1$NestedClass2");
  }

  @Test
  public void testClassExtendedSuperClassAndImplementedTwoInterfaces() {
    // Given
    final var superClassName = "intellispaces.common.javastatement.samples.ClassExtendedSuperClassAndImplementedTwoInterfaces.SuperClass";
    final var interface1Name = "intellispaces.common.javastatement.samples.ClassExtendedSuperClassAndImplementedTwoInterfaces.Interface1";
    final var interface2Name = "intellispaces.common.javastatement.samples.ClassExtendedSuperClassAndImplementedTwoInterfaces.Interface2";
    ...
    assertThat(classStatement.canonicalName()).isEqualTo("intellispaces.common.javastatement.samples.ClassExtendedSuperClassAndImplementedTwoInterfaces.TesteeClass");
    assertThat(classStatement.className()).isEqualTo("intellispaces.common.javastatement.samples.ClassExtendedSuperClassAndImplementedTwoInterfaces$TesteeClass");
  ...
  public void testClassWithDefaultConstructor() {
    // Given
    String canonicalClassName = "intellispaces.common.javastatement.samples.ClassWithDefaultConstructor";
  ...
  private void testClassWithOneMethod(
    ...
    // Given
    String canonicalClassName = "intellispaces.common.javastatement.samples." + className;
