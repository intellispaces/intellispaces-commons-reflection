...
public class RecordTest extends AbstractCustomStatementTest {
  ...
  public void testEmptyRecord() {
    ...
    assertThat(recordStatement.canonicalName()).isEqualTo("intellispaces.common.javastatement.samples.EmptyRecord");
    assertThat(recordStatement.className()).isEqualTo("intellispaces.common.javastatement.samples.EmptyRecord");
  ...
  public void testRecordImplementedTwoInterfaces() {
    // Given
    final var interface1Name = "intellispaces.common.javastatement.samples.RecordImplementedTwoInterfaces.Interface1";
    final var interface2Name = "intellispaces.common.javastatement.samples.RecordImplementedTwoInterfaces.Interface2";
    ...
    assertThat(recordStatement.canonicalName()).isEqualTo("intellispaces.common.javastatement.samples.RecordImplementedTwoInterfaces.TesteeRecord");
    assertThat(recordStatement.className()).isEqualTo("intellispaces.common.javastatement.samples.RecordImplementedTwoInterfaces$TesteeRecord");
  ...
  private void testRecordWithOneMethod(
    ...
    // Given
    String canonicalClassName = "intellispaces.common.javastatement.samples." + recordName;
