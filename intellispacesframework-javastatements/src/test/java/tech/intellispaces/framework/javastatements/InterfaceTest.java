...
public class InterfaceTest extends AbstractCustomTypeTest {
  ...
  public void testEmptyInterface() {
    ...
    assertThat(interfaceStatement.canonicalName()).isEqualTo("tech.intellispaces.framework.javastatements.samples.EmptyInterface");
    assertThat(interfaceStatement.className()).isEqualTo("tech.intellispaces.framework.javastatements.samples.EmptyInterface");
  ...
  public void testNestedInterface() {
    ...
    assertThat(interfaceStatement.canonicalName()).isEqualTo("tech.intellispaces.framework.javastatements.samples.NestedInterface.NestedInterface1.NestedInterface2");
    assertThat(interfaceStatement.className()).isEqualTo("tech.intellispaces.framework.javastatements.samples.NestedInterface$NestedInterface1$NestedInterface2");
  }
  ...
  public void testInterfaceExtendedTwoInterfaces() {
    ...
    assertThat(interfaceStatement.canonicalName()).isEqualTo("tech.intellispaces.framework.javastatements.samples.InterfaceExtendedTwoInterfaces.TesteeInterface");
    assertThat(interfaceStatement.className()).isEqualTo("tech.intellispaces.framework.javastatements.samples.InterfaceExtendedTwoInterfaces$TesteeInterface");
