...
public class RecordTest extends AbstractCustomTypeTest {
  ...
  public void testEmptyRecord() {
    ...
    assertThat(recordStatement.canonicalName()).isEqualTo("tech.intellispaces.framework.javastatements.samples.EmptyRecord");
    assertThat(recordStatement.className()).isEqualTo("tech.intellispaces.framework.javastatements.samples.EmptyRecord");
  ...
  public void testRecordImplementedTwoInterfaces() {
    ...
    assertThat(recordStatement.canonicalName()).isEqualTo("tech.intellispaces.framework.javastatements.samples.RecordImplementedTwoInterfaces.TesteeRecord");
    assertThat(recordStatement.className()).isEqualTo("tech.intellispaces.framework.javastatements.samples.RecordImplementedTwoInterfaces$TesteeRecord");
