...
import tech.intellispaces.statementsj.samples.AnnotationWithElementsView;
import tech.intellispaces.statementsj.samples.TestAnnotation;
import tech.intellispaces.statementsj.samples.TestEnum;
...
public class AnnotationTest extends AbstractCustomStatementTest {
  ...
  public void testEmptyAnnotation() {
    ...
    assertThat(annotationStatement.canonicalName()).isEqualTo("tech.intellispaces.statementsj.samples.EmptyAnnotation");
    assertThat(annotationStatement.className()).isEqualTo("tech.intellispaces.statementsj.samples.EmptyAnnotation");
  ...
  public void testAnnotationWithArrayOfAnnotationElement() {
    testAnnotationWithElement("AnnotationWithArrayOfAnnotationElement", "arrayOfAnnotationElement",
            List.of("tech.intellispaces.statementsj.samples.TestAnnotation"),
            elementMethod -> {
      Assertions.assertThat(elementMethod.returnType().orElseThrow()
          .asArrayReference().orElseThrow()
  ...
  private void testAnnotationWithElement(
    ...
    assertThat(annotationStatement.dependencyTypenames()).containsExactlyInAnyOrderElementsOf(
            CollectionFunctions.join(dependencies, "tech.intellispaces.statementsj.support.TesteeType"));
  ...
  public void testCyclicAnnotation() {
    ...
    String annotationClassName = "tech.intellispaces.statementsj.samples.CyclicAnnotations.SomeAnnotation";
  ...
  public void testAnnotationInstance() {
    ...
    assertThat(annotatedClass.dependencyTypenames()).containsExactlyInAnyOrder(
        "tech.intellispaces.statementsj.support.TesteeType",
        "tech.intellispaces.statementsj.samples.TestEnum",
