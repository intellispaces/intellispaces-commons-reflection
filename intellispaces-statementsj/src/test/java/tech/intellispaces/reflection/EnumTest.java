...
public class EnumTest extends AbstractCustomStatementTest {
  ...
  public void testEmptyEnum() {
    ...
    assertThat(enumStatement.canonicalName()).isEqualTo("tech.intellispaces.statementsj.samples.EmptyEnum");
    assertThat(enumStatement.className()).isEqualTo("tech.intellispaces.statementsj.samples.EmptyEnum");
  ...
  public void testEnumImplementedTwoInterfaces() {
    // Given
    final var interface1Name = "tech.intellispaces.statementsj.samples.EnumImplementedTwoInterfaces.Interface1";
    final var interface2Name = "tech.intellispaces.statementsj.samples.EnumImplementedTwoInterfaces.Interface2";
    ...
    assertThat(enumStatement.canonicalName()).isEqualTo("tech.intellispaces.statementsj.samples.EnumImplementedTwoInterfaces.TesteeEnum");
    assertThat(enumStatement.className()).isEqualTo("tech.intellispaces.statementsj.samples.EnumImplementedTwoInterfaces$TesteeEnum");
    ...
    assertThat(enumStatement.dependencyTypenames()).containsExactlyInAnyOrder(
        "tech.intellispaces.statementsj.support.TesteeType",
        "tech.intellispaces.statementsj.samples.EnumImplementedTwoInterfaces.Interface1",
        "tech.intellispaces.statementsj.samples.EnumImplementedTwoInterfaces.Interface2"
    );

    assertThat(enumStatement.implementedInterfaces().get(0).actualDeclaration()).isEqualTo("tech.intellispaces.statementsj.samples.EnumImplementedTwoInterfaces.Interface1");
    assertThat(enumStatement.implementedInterfaces().get(1).actualDeclaration()).isEqualTo("tech.intellispaces.statementsj.samples.EnumImplementedTwoInterfaces.Interface2");
  }
  ...
  private void testEnumWithOneMethod(
    ...
    // Given
    String enumClassName = "tech.intellispaces.statementsj.samples." + className;
