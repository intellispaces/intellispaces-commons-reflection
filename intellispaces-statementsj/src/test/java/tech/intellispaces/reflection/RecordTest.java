...
public class RecordTest extends AbstractCustomStatementTest {
  ...
  public void testEmptyRecord() {
    ...
    assertThat(recordStatement.canonicalName()).isEqualTo("tech.intellispaces.statementsj.samples.EmptyRecord");
    assertThat(recordStatement.className()).isEqualTo("tech.intellispaces.statementsj.samples.EmptyRecord");
  ...
  public void testRecordImplementedTwoInterfaces() {
    // Given
    final var interface1Name = "tech.intellispaces.statementsj.samples.RecordImplementedTwoInterfaces.Interface1";
    final var interface2Name = "tech.intellispaces.statementsj.samples.RecordImplementedTwoInterfaces.Interface2";
    ...
    assertThat(recordStatement.canonicalName()).isEqualTo("tech.intellispaces.statementsj.samples.RecordImplementedTwoInterfaces.TesteeRecord");
    assertThat(recordStatement.className()).isEqualTo("tech.intellispaces.statementsj.samples.RecordImplementedTwoInterfaces$TesteeRecord");
    ...
    assertThat(recordStatement.dependencyTypenames()).containsExactlyInAnyOrder(
        "tech.intellispaces.statementsj.support.TesteeType",
        "tech.intellispaces.statementsj.samples.RecordImplementedTwoInterfaces.Interface1",
        "tech.intellispaces.statementsj.samples.RecordImplementedTwoInterfaces.Interface2"
    );

    assertThat(recordStatement.implementedInterfaces().get(0).actualDeclaration()).isEqualTo("tech.intellispaces.statementsj.samples.RecordImplementedTwoInterfaces.Interface1");
    assertThat(recordStatement.implementedInterfaces().get(1).actualDeclaration()).isEqualTo("tech.intellispaces.statementsj.samples.RecordImplementedTwoInterfaces.Interface2");
  }
  ...
  public void testGenericRecordWithCyclicTypeDependencyCase1() {
    ...
    // Then
    assertThat(typeReference.actualDeclaration()).isEqualTo("tech.intellispaces.statementsj.samples.GenericRecordWithCyclicTypeDependencyCase1");
    assertThat(typeReference.formalFullDeclaration()).isEqualTo("GenericRecordWithCyclicTypeDependencyCase1<T extends tech.intellispaces.statementsj.samples.GenericRecordWithCyclicTypeDependencyCase1<T>>");
    assertThat(typeReference.formalBriefDeclaration()).isEqualTo("GenericRecordWithCyclicTypeDependencyCase1<T>");
    assertThat(typeReference.targetType().typeParametersFullDeclaration()).isEqualTo("<T extends tech.intellispaces.statementsj.samples.GenericRecordWithCyclicTypeDependencyCase1<T>>");
  ...
  public void testGenericRecordWithCyclicTypeDependencyCase2() {
    ...
    // Then
    assertThat(typeReference.actualDeclaration()).isEqualTo("tech.intellispaces.statementsj.samples.GenericRecordWithCyclicTypeDependencyCase2.RecordA");
    assertThat(typeReference.formalFullDeclaration()).isEqualTo("RecordA<T1 extends tech.intellispaces.statementsj.samples.GenericRecordWithCyclicTypeDependencyCase2.RecordB<?>>");
    assertThat(typeReference.formalBriefDeclaration()).isEqualTo("RecordA<T1>");
    assertThat(typeReference.targetType().typeParametersFullDeclaration()).isEqualTo("<T1 extends tech.intellispaces.statementsj.samples.GenericRecordWithCyclicTypeDependencyCase2.RecordB<?>>");
    ...
    ObjectFunctions.handle(recordStatement.typeParameters().get(0), classATypeParam -> {
      ...
      ObjectFunctions.handle(classATypeParam.extendedBounds().get(0).asCustomTypeReference().orElseThrow().targetType(), classBExtendedBound -> {
        assertThat(classBExtendedBound.canonicalName()).isEqualTo("tech.intellispaces.statementsj.samples.GenericRecordWithCyclicTypeDependencyCase2.RecordB");
        assertThat(classBExtendedBound.className()).isEqualTo("tech.intellispaces.statementsj.samples.GenericRecordWithCyclicTypeDependencyCase2$RecordB");
  ...
  private void testRecordWithOneMethod(
    ...
    // Given
    String canonicalClassName = "tech.intellispaces.statementsj.samples." + recordName;
