...
public class ClassTest extends AbstractCustomStatementTest {
  ...
  public void testEmptyClass() {
    ...
    assertThat(classStatement.canonicalName()).isEqualTo("tech.intellispaces.statementsj.samples.EmptyClass");
    assertThat(classStatement.className()).isEqualTo("tech.intellispaces.statementsj.samples.EmptyClass");
    ...
    ObjectFunctions.handle(classStatement.annotations().get(0), annInstance -> {
    ...
    assertThat(classStatement.dependencyTypenames()).containsExactlyInAnyOrder(
        "tech.intellispaces.statementsj.support.TesteeType"
    );
  }
  ...
  public void testNestedClass() {
    ...
    assertThat(classStatement.canonicalName()).isEqualTo("tech.intellispaces.statementsj.samples.NestedClass.NestedClass1.NestedClass2");
    assertThat(classStatement.className()).isEqualTo("tech.intellispaces.statementsj.samples.NestedClass$NestedClass1$NestedClass2");
  }

  @Test
  public void testClassExtendedSuperClassAndImplementedTwoInterfaces() {
    // Given
    final var superClassName = "tech.intellispaces.statementsj.samples.ClassExtendedSuperClassAndImplementedTwoInterfaces.SuperClass";
    final var interface1Name = "tech.intellispaces.statementsj.samples.ClassExtendedSuperClassAndImplementedTwoInterfaces.Interface1";
    final var interface2Name = "tech.intellispaces.statementsj.samples.ClassExtendedSuperClassAndImplementedTwoInterfaces.Interface2";
    ...
    assertThat(classStatement.canonicalName()).isEqualTo("tech.intellispaces.statementsj.samples.ClassExtendedSuperClassAndImplementedTwoInterfaces.TesteeClass");
    assertThat(classStatement.className()).isEqualTo("tech.intellispaces.statementsj.samples.ClassExtendedSuperClassAndImplementedTwoInterfaces$TesteeClass");
    ...
    ObjectFunctions.handle(classStatement.extendedClass().orElseThrow(), extendedClass -> {
    ...
    ObjectFunctions.handle(classStatement.implementedInterfaces().get(0), implInterface -> {
      assertThat(implInterface.targetType().canonicalName()).isEqualTo(interface1Name);
      assertThat(implInterface.typeArguments()).isEmpty();
    });
    ObjectFunctions.handle(classStatement.implementedInterfaces().get(1), implInterface -> {
    ...
    ObjectFunctions.handle(classStatement.parentTypes().get(0), parentType -> {
      assertThat(parentType.targetType().canonicalName()).isEqualTo(superClassName);
      assertThat(parentType.typeArguments()).isEmpty();
    });
    ObjectFunctions.handle(classStatement.parentTypes().get(1), parentType -> {
      assertThat(parentType.targetType().canonicalName()).isEqualTo(interface1Name);
      assertThat(parentType.typeArguments()).isEmpty();
    });
    ObjectFunctions.handle(classStatement.parentTypes().get(2), parentType -> {
    ...
    assertThat(classStatement.dependencyTypenames()).containsExactlyInAnyOrder(
        "tech.intellispaces.statementsj.support.TesteeType",
        "tech.intellispaces.statementsj.samples.ClassExtendedSuperClassAndImplementedTwoInterfaces.Interface1",
        "tech.intellispaces.statementsj.samples.ClassExtendedSuperClassAndImplementedTwoInterfaces.Interface2",
        "tech.intellispaces.statementsj.samples.ClassExtendedSuperClassAndImplementedTwoInterfaces.SuperClass"
    );

    assertThat(classStatement.extendedClass().orElseThrow().actualDeclaration()).isEqualTo("tech.intellispaces.statementsj.samples.ClassExtendedSuperClassAndImplementedTwoInterfaces.SuperClass");
    assertThat(classStatement.implementedInterfaces().get(0).actualDeclaration()).isEqualTo("tech.intellispaces.statementsj.samples.ClassExtendedSuperClassAndImplementedTwoInterfaces.Interface1");
    assertThat(classStatement.implementedInterfaces().get(1).actualDeclaration()).isEqualTo("tech.intellispaces.statementsj.samples.ClassExtendedSuperClassAndImplementedTwoInterfaces.Interface2");
  }

  @Test
  public void testClassWithDefaultConstructor() {
    // Given
    String canonicalClassName = "tech.intellispaces.statementsj.samples.ClassWithDefaultConstructor";
  ...
  public void testClassWithEnumGetter() {
    testClassWithOneMethod(
        ...
        List.of("tech.intellispaces.statementsj.samples.TestEnum"));
  }
  ...
  public void testClassWithRecordGetter() {
    testClassWithOneMethod(
        ...
        List.of("tech.intellispaces.statementsj.samples.TestRecord"));
  }
  ...
  public void testGenericClassWithOneTypeParameter() {
    ...
    // Then
    assertThat(typeReference.actualDeclaration()).isEqualTo("tech.intellispaces.statementsj.samples.GenericClassWithOneTypeParameter");
    ...
    ObjectFunctions.handle(classStatement.typeParameters().get(0), typeParam -> {
      assertThat(typeParam.name()).isEqualTo("T");
      assertThat(typeParam.extendedBounds()).isEmpty();
    });

    assertThat(classStatement.declaredMethods()).hasSize(1);
    ObjectFunctions.handle(classStatement.declaredMethods().get(0), method -> {
  ...
  public void testGenericClassWithMultipleTypeParameters() {
    ...
    ObjectFunctions.handle(classStatement.typeParameters().get(1), typeParam -> {
    ...
    ObjectFunctions.handle(classStatement.typeParameters().get(2), typeParam -> {
      ...
      assertThat(typeParam.formalFullDeclaration()).isEqualTo("T3 extends java.lang.Number");
      assertThat(typeParam.formalBriefDeclaration()).isEqualTo("T3");
    });

    ObjectFunctions.handle(classStatement.typeParameters().get(3), typeParam -> {
      ...
      assertThat(typeParam.formalFullDeclaration()).isEqualTo("T4 extends java.lang.AutoCloseable & java.io.DataInput");
  ...
  public void testGenericClassWithCyclicTypeDependencyCase1() {
    ...
    // Then
    assertThat(typeReference.actualDeclaration()).isEqualTo("tech.intellispaces.statementsj.samples.GenericClassWithCyclicTypeDependencyCase1");
    assertThat(typeReference.formalFullDeclaration()).isEqualTo("GenericClassWithCyclicTypeDependencyCase1<T extends tech.intellispaces.statementsj.samples.GenericClassWithCyclicTypeDependencyCase1<T>>");
  ...
  public void testGenericClassWithCyclicTypeDependencyCase2() {
    ...
    // Then
    assertThat(typeReference.actualDeclaration()).isEqualTo("tech.intellispaces.statementsj.samples.GenericClassWithCyclicTypeDependencyCase2.ClassA");
    assertThat(typeReference.formalFullDeclaration()).isEqualTo("ClassA<T1 extends tech.intellispaces.statementsj.samples.GenericClassWithCyclicTypeDependencyCase2.ClassB<?>>");
    assertThat(typeReference.formalBriefDeclaration()).isEqualTo("ClassA<T1>");
    assertThat(typeReference.targetType().typeParametersFullDeclaration()).isEqualTo("<T1 extends tech.intellispaces.statementsj.samples.GenericClassWithCyclicTypeDependencyCase2.ClassB<?>>");
    ...
    ObjectFunctions.handle(classAStatement.typeParameters().get(0), classATypeParam -> {
      ...
      ObjectFunctions.handle(classATypeParam.extendedBounds().get(0).asCustomTypeReference().orElseThrow().targetType(), classBExtendedBound -> {
        assertThat(classBExtendedBound.canonicalName()).isEqualTo("tech.intellispaces.statementsj.samples.GenericClassWithCyclicTypeDependencyCase2.ClassB");
        assertThat(classBExtendedBound.className()).isEqualTo("tech.intellispaces.statementsj.samples.GenericClassWithCyclicTypeDependencyCase2$ClassB");
  ...
  private void testClassWithOneMethod(
    ...
    // Given
    String canonicalClassName = "tech.intellispaces.statementsj.samples." + className;
    ...
    assertThat(classStatement.dependencyTypenames()).containsExactlyInAnyOrderElementsOf(
        CollectionFunctions.join(additionalImports, "tech.intellispaces.statementsj.support.TesteeType")
    );
  ...
  public void testClassInheritedFromGenericClassAndOneAbstractMethod() {
    ...
    assertThat(declaredMethods.get(0).owner().canonicalName()).isEqualTo(
        "tech.intellispaces.statementsj.samples.ClassInheritedFromGenericClassAndOneAbstractMethod.ChildClass");
  ...
  public void testClassImplementedInterfaceWithDefaultMethod1() {
    ...
    assertThat(actualMethods.get(0).isAbstract()).isFalse();
    assertThat(actualMethods.get(0).owner().canonicalName()).isEqualTo(
        "tech.intellispaces.statementsj.samples.ClassImplementedInterfaceWithDefaultMethod1.Interface2");
  }
  ...
  public void testClassImplementedInterfaceWithGenericDefaultMethod1() {
    ...
    assertThat(actualMethods.get(0).owner().canonicalName()).isEqualTo(
        "tech.intellispaces.statementsj.samples.ClassImplementedInterfaceWithGenericDefaultMethod1.Interface2");
  }
  ...
  public void testClassImplementedInterfaceWithGenericDefaultMethod2() {
    ...
    assertThat(actualMethods.get(0).isDefault()).isTrue();
    assertThat(actualMethods.get(0).owner().canonicalName()).isEqualTo(
        "tech.intellispaces.statementsj.samples.ClassImplementedInterfaceWithGenericDefaultMethod2.Interface2");
  }
  ...
  public void testClassImplementedInterfaceWithGenericDefaultMethod3() {
    ...
    assertThat(actualMethods.get(0).isDefault()).isTrue();
    assertThat(actualMethods.get(0).owner().canonicalName()).isEqualTo(
        "tech.intellispaces.statementsj.samples.ClassImplementedInterfaceWithGenericDefaultMethod3.Interface2");
  }
  ...
  public void testClassImplementedInterfaceWithGenericDefaultMethod4() {
    ...
    assertThat(actualMethods.get(0).isDefault()).isTrue();
    assertThat(actualMethods.get(0).owner().canonicalName()).isEqualTo(
        "tech.intellispaces.statementsj.samples.ClassImplementedInterfaceWithGenericDefaultMethod4.Interface2");
  }
}
