...
public class EnumTest extends AbstractCustomStatementTest {
  ...
  public void testEmptyEnum() {
    ...
    assertThat(enumStatement.canonicalName()).isEqualTo("tech.intellispaces.commons.reflection.samples.EmptyEnum");
    assertThat(enumStatement.className()).isEqualTo("tech.intellispaces.commons.reflection.samples.EmptyEnum");
  ...
  public void testEnumImplementedTwoInterfaces() {
    // Given
    final var interface1Name = "tech.intellispaces.commons.reflection.samples.EnumImplementedTwoInterfaces.Interface1";
    final var interface2Name = "tech.intellispaces.commons.reflection.samples.EnumImplementedTwoInterfaces.Interface2";
    ...
    assertThat(enumStatement.canonicalName()).isEqualTo("tech.intellispaces.commons.reflection.samples.EnumImplementedTwoInterfaces.TesteeEnum");
    assertThat(enumStatement.className()).isEqualTo("tech.intellispaces.commons.reflection.samples.EnumImplementedTwoInterfaces$TesteeEnum");
    ...
    assertThat(enumStatement.implementedInterfaces().get(0).actualDeclaration()).isEqualTo("tech.intellispaces.commons.reflection.samples.EnumImplementedTwoInterfaces.Interface1");
    assertThat(enumStatement.implementedInterfaces().get(1).actualDeclaration()).isEqualTo("tech.intellispaces.commons.reflection.samples.EnumImplementedTwoInterfaces.Interface2");
  }
  ...
  private void testEnumWithOneMethod(
    ...
    // Given
    String enumClassName = "tech.intellispaces.commons.reflection.samples." + className;
