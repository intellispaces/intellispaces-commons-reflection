...
import tech.intellispaces.commons.reflection.samples.AnnotationWithElementsView;
import tech.intellispaces.commons.reflection.samples.TestAnnotation;
import tech.intellispaces.commons.reflection.samples.TestEnum;
...
public class AnnotationTest extends AbstractCustomStatementTest {
  ...
  public void testEmptyAnnotation() {
    ...
    assertThat(annotationStatement.canonicalName()).isEqualTo("tech.intellispaces.commons.reflection.samples.EmptyAnnotation");
    assertThat(annotationStatement.className()).isEqualTo("tech.intellispaces.commons.reflection.samples.EmptyAnnotation");
  ...
  private void testAnnotationWithElement(String className, String elementMethodName, Consumer<MethodStatement> methodValidator) {
    ...
    assertThat(annotationStatement.dependencyTypenames()).containsExactlyInAnyOrder("tech.intellispaces.commons.reflection.support.TesteeType");
  ...
  public void testCyclicAnnotation() {
    ...
    String annotationClassName = "tech.intellispaces.commons.reflection.samples.CyclicAnnotations.SomeAnnotation";
