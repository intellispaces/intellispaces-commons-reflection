...
import tech.intellispaces.commons.reflection.samples.TestRecord;
import tech.intellispaces.commons.reflection.support.TesteeTypeAnnotationProcessor;
...
class AbstractCustomStatementTest {
  ...
  protected void validateEnumGetter(MethodStatement method) {
    ...
    assertThat(method.returnType().orElseThrow().actualDeclaration()).isEqualTo("tech.intellispaces.commons.reflection.samples.TestEnum");
    assertThat(method.params()).isEmpty();
  }
  ...
  protected void validateRecordGetter(MethodStatement method) {
    ...
    assertThat(method.params()).isEmpty();
    assertThat(method.returnType().orElseThrow().actualDeclaration()).isEqualTo("tech.intellispaces.commons.reflection.samples.TestRecord");
  }
