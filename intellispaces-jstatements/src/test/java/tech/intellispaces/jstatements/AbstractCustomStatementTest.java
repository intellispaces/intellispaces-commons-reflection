...
import tech.intellispaces.jstatements.samples.TestRecord;
import tech.intellispaces.jstatements.support.TesteeTypeAnnotationProcessor;
...
public class AbstractCustomStatementTest {
  ...
  protected void validateEnumGetter(MethodStatement method) {
    ...
    assertThat(method.returnType().orElseThrow().actualDeclaration()).isEqualTo("tech.intellispaces.jstatements.samples.TestEnum");
    assertThat(method.params()).isEmpty();
  }
  ...
  protected void validateRecordGetter(MethodStatement method) {
    ...
    assertThat(method.params()).isEmpty();
    assertThat(method.returnType().orElseThrow().actualDeclaration()).isEqualTo("tech.intellispaces.jstatements.samples.TestRecord");
  }
