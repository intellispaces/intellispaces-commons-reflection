...
public class EnumTest extends AbstractCustomStatementTest {
  ...
  public void testEmptyEnum() {
    ...
    assertThat(enumStatement.canonicalName()).isEqualTo("tech.intellispaces.jstatements.samples.EmptyEnum");
    assertThat(enumStatement.className()).isEqualTo("tech.intellispaces.jstatements.samples.EmptyEnum");
  ...
  public void testEnumImplementedTwoInterfaces() {
    // Given
    final var interface1Name = "tech.intellispaces.jstatements.samples.EnumImplementedTwoInterfaces.Interface1";
    final var interface2Name = "tech.intellispaces.jstatements.samples.EnumImplementedTwoInterfaces.Interface2";
    ...
    assertThat(enumStatement.canonicalName()).isEqualTo("tech.intellispaces.jstatements.samples.EnumImplementedTwoInterfaces.TesteeEnum");
    assertThat(enumStatement.className()).isEqualTo("tech.intellispaces.jstatements.samples.EnumImplementedTwoInterfaces$TesteeEnum");
    ...
    assertThat(enumStatement.dependencyTypenames()).containsExactlyInAnyOrder(
        "tech.intellispaces.jstatements.support.TesteeType",
        "tech.intellispaces.jstatements.samples.EnumImplementedTwoInterfaces.Interface1",
        "tech.intellispaces.jstatements.samples.EnumImplementedTwoInterfaces.Interface2"
    );

    assertThat(enumStatement.implementedInterfaces().get(0).actualDeclaration()).isEqualTo("tech.intellispaces.jstatements.samples.EnumImplementedTwoInterfaces.Interface1");
    assertThat(enumStatement.implementedInterfaces().get(1).actualDeclaration()).isEqualTo("tech.intellispaces.jstatements.samples.EnumImplementedTwoInterfaces.Interface2");
  }
  ...
  private void testEnumWithOneMethod(
    ...
    // Given
    String enumClassName = "tech.intellispaces.jstatements.samples." + className;
