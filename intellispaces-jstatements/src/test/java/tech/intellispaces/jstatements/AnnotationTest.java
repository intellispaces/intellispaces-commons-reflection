...
import tech.intellispaces.jstatements.samples.AnnotationWithElementsView;
import tech.intellispaces.jstatements.samples.TestAnnotation;
import tech.intellispaces.jstatements.samples.TestEnum;
...
public class AnnotationTest extends AbstractCustomStatementTest {
  ...
  public void testEmptyAnnotation() {
    ...
    assertThat(annotationStatement.canonicalName()).isEqualTo("tech.intellispaces.jstatements.samples.EmptyAnnotation");
    assertThat(annotationStatement.className()).isEqualTo("tech.intellispaces.jstatements.samples.EmptyAnnotation");
  ...
  public void testAnnotationWithArrayOfAnnotationElement() {
    testAnnotationWithElement("AnnotationWithArrayOfAnnotationElement", "arrayOfAnnotationElement",
            List.of("tech.intellispaces.jstatements.samples.TestAnnotation"),
            elementMethod -> {
      Assertions.assertThat(elementMethod.returnType().orElseThrow()
          .asArrayReference().orElseThrow()
  ...
  private void testAnnotationWithElement(
    ...
    assertThat(annotationStatement.dependencyTypenames()).containsExactlyInAnyOrderElementsOf(
            CollectionFunctions.join(dependencies, "tech.intellispaces.jstatements.support.TesteeType"));
  ...
  public void testCyclicAnnotation() {
    ...
    String annotationClassName = "tech.intellispaces.jstatements.samples.CyclicAnnotations.SomeAnnotation";
  ...
  public void testAnnotationInstance() {
    ...
    assertThat(annotatedClass.dependencyTypenames()).containsExactlyInAnyOrder(
        "tech.intellispaces.jstatements.support.TesteeType",
        "tech.intellispaces.jstatements.samples.TestEnum",
