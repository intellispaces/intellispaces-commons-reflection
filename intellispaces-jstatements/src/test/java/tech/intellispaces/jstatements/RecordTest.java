...
import tech.intellispaces.jstatements.customtype.RecordType;
...
public class RecordTest extends AbstractCustomStatementTest {
  ...
  public void testEmptyRecord() {
    ...
    assertThat(recordStatement.canonicalName()).isEqualTo("tech.intellispaces.jstatements.samples.EmptyRecord");
    assertThat(recordStatement.className()).isEqualTo("tech.intellispaces.jstatements.samples.EmptyRecord");
  ...
  public void testRecordImplementedTwoInterfaces() {
    // Given
    final var interface1Name = "tech.intellispaces.jstatements.samples.RecordImplementedTwoInterfaces.Interface1";
    final var interface2Name = "tech.intellispaces.jstatements.samples.RecordImplementedTwoInterfaces.Interface2";
    ...
    assertThat(recordStatement.canonicalName()).isEqualTo("tech.intellispaces.jstatements.samples.RecordImplementedTwoInterfaces.TesteeRecord");
    assertThat(recordStatement.className()).isEqualTo("tech.intellispaces.jstatements.samples.RecordImplementedTwoInterfaces$TesteeRecord");
    ...
    assertThat(recordStatement.dependencyTypenames()).containsExactlyInAnyOrder(
        "tech.intellispaces.jstatements.support.TesteeType",
        "tech.intellispaces.jstatements.samples.RecordImplementedTwoInterfaces.Interface1",
        "tech.intellispaces.jstatements.samples.RecordImplementedTwoInterfaces.Interface2"
    );

    assertThat(recordStatement.implementedInterfaces().get(0).actualDeclaration()).isEqualTo("tech.intellispaces.jstatements.samples.RecordImplementedTwoInterfaces.Interface1");
    assertThat(recordStatement.implementedInterfaces().get(1).actualDeclaration()).isEqualTo("tech.intellispaces.jstatements.samples.RecordImplementedTwoInterfaces.Interface2");
  }
  ...
  public void testGenericRecordWithCyclicTypeDependencyCase1() {
    ...
    // Then
    assertThat(typeReference.actualDeclaration()).isEqualTo("tech.intellispaces.jstatements.samples.GenericRecordWithCyclicTypeDependencyCase1");
    assertThat(typeReference.formalFullDeclaration()).isEqualTo("GenericRecordWithCyclicTypeDependencyCase1<T extends tech.intellispaces.jstatements.samples.GenericRecordWithCyclicTypeDependencyCase1<T>>");
    assertThat(typeReference.formalBriefDeclaration()).isEqualTo("GenericRecordWithCyclicTypeDependencyCase1<T>");
    assertThat(typeReference.targetType().typeParametersFullDeclaration()).isEqualTo("<T extends tech.intellispaces.jstatements.samples.GenericRecordWithCyclicTypeDependencyCase1<T>>");
  ...
  public void testGenericRecordWithCyclicTypeDependencyCase2() {
    ...
    // Then
    assertThat(typeReference.actualDeclaration()).isEqualTo("tech.intellispaces.jstatements.samples.GenericRecordWithCyclicTypeDependencyCase2.RecordA");
    assertThat(typeReference.formalFullDeclaration()).isEqualTo("RecordA<T1 extends tech.intellispaces.jstatements.samples.GenericRecordWithCyclicTypeDependencyCase2.RecordB<?>>");
    assertThat(typeReference.formalBriefDeclaration()).isEqualTo("RecordA<T1>");
    assertThat(typeReference.targetType().typeParametersFullDeclaration()).isEqualTo("<T1 extends tech.intellispaces.jstatements.samples.GenericRecordWithCyclicTypeDependencyCase2.RecordB<?>>");
    ...
    ObjectFunctions.handle(recordStatement.typeParameters().get(0), classATypeParam -> {
      ...
      ObjectFunctions.handle(classATypeParam.extendedBounds().get(0).asCustomTypeReference().orElseThrow().targetType(), classBExtendedBound -> {
        assertThat(classBExtendedBound.canonicalName()).isEqualTo("tech.intellispaces.jstatements.samples.GenericRecordWithCyclicTypeDependencyCase2.RecordB");
        assertThat(classBExtendedBound.className()).isEqualTo("tech.intellispaces.jstatements.samples.GenericRecordWithCyclicTypeDependencyCase2$RecordB");
  ...
  private void testRecordWithOneMethod(
    ...
    // Given
    String canonicalClassName = "tech.intellispaces.jstatements.samples." + recordName;
