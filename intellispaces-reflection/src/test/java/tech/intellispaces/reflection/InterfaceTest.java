...
public class InterfaceTest extends AbstractCustomStatementTest {
  ...
  public void testEmptyInterface() {
    ...
    assertThat(interfaceStatement.canonicalName()).isEqualTo("tech.intellispaces.reflection.samples.EmptyInterface");
    assertThat(interfaceStatement.className()).isEqualTo("tech.intellispaces.reflection.samples.EmptyInterface");
  ...
  public void testNestedInterface() {
    ...
    assertThat(interfaceStatement.canonicalName()).isEqualTo("tech.intellispaces.reflection.samples.NestedInterface.NestedInterface1.NestedInterface2");
    assertThat(interfaceStatement.className()).isEqualTo("tech.intellispaces.reflection.samples.NestedInterface$NestedInterface1$NestedInterface2");
  }

  @Test
  public void testInterfaceExtendedTwoInterfaces() {
    // Given
    final var interface1Name = "tech.intellispaces.reflection.samples.InterfaceExtendedTwoInterfaces.Interface1";
    final var interface2Name = "tech.intellispaces.reflection.samples.InterfaceExtendedTwoInterfaces.Interface2";
    ...
    assertThat(interfaceStatement.canonicalName()).isEqualTo("tech.intellispaces.reflection.samples.InterfaceExtendedTwoInterfaces.TesteeInterface");
    assertThat(interfaceStatement.className()).isEqualTo("tech.intellispaces.reflection.samples.InterfaceExtendedTwoInterfaces$TesteeInterface");
    ...
    assertThat(interfaceStatement.extendedInterfaces().get(1).actualDeclaration()).isEqualTo("tech.intellispaces.reflection.samples.InterfaceExtendedTwoInterfaces.Interface2");
  }
  ...
  public void testGenericInterfaceWithCyclicTypeDependencyCase1() {
    ...
    // Then
    assertThat(typeReference.actualDeclaration()).isEqualTo("tech.intellispaces.reflection.samples.GenericInterfaceWithCyclicTypeDependencyCase1");
    assertThat(typeReference.formalFullDeclaration()).isEqualTo("GenericInterfaceWithCyclicTypeDependencyCase1<T extends tech.intellispaces.reflection.samples.GenericInterfaceWithCyclicTypeDependencyCase1<T>>");
    assertThat(typeReference.formalBriefDeclaration()).isEqualTo("GenericInterfaceWithCyclicTypeDependencyCase1<T>");
    assertThat(typeReference.targetType().typeParametersFullDeclaration()).isEqualTo("<T extends tech.intellispaces.reflection.samples.GenericInterfaceWithCyclicTypeDependencyCase1<T>>");
  ...
  public void testGenericInterfaceWithCyclicTypeDependencyCase2() {
    ...
    // Then
    assertThat(typeReference.actualDeclaration()).isEqualTo("tech.intellispaces.reflection.samples.GenericInterfaceWithCyclicTypeDependencyCase2.InterfaceA");
    assertThat(typeReference.formalFullDeclaration()).isEqualTo("InterfaceA<T1 extends tech.intellispaces.reflection.samples.GenericInterfaceWithCyclicTypeDependencyCase2.InterfaceB<?>>");
    assertThat(typeReference.formalBriefDeclaration()).isEqualTo("InterfaceA<T1>");
    assertThat(typeReference.targetType().typeParametersFullDeclaration()).isEqualTo("<T1 extends tech.intellispaces.reflection.samples.GenericInterfaceWithCyclicTypeDependencyCase2.InterfaceB<?>>");
    ...
    ObjectFunctions.handle(interfaceStatement.typeParameters().get(0), classATypeParam -> {
      ...
      ObjectFunctions.handle(classATypeParam.extendedBounds().get(0).asCustomTypeReference().orElseThrow().targetType(), classBExtendedBound -> {
        assertThat(classBExtendedBound.canonicalName()).isEqualTo("tech.intellispaces.reflection.samples.GenericInterfaceWithCyclicTypeDependencyCase2.InterfaceB");
        assertThat(classBExtendedBound.className()).isEqualTo("tech.intellispaces.reflection.samples.GenericInterfaceWithCyclicTypeDependencyCase2$InterfaceB");
  ...
  private void testInterfaceWithOneMethod(
    ...
    // Given
    String canonicalClassName = "tech.intellispaces.reflection.samples." + interfaceName;
