...
import tech.intellispaces.reflection.samples.TestRecord;
import tech.intellispaces.reflection.support.TesteeTypeAnnotationProcessor;
...
public class AbstractCustomStatementTest {
  ...
  protected void validateEnumGetter(MethodStatement method) {
    ...
    assertThat(method.returnType().orElseThrow().actualDeclaration()).isEqualTo("tech.intellispaces.reflection.samples.TestEnum");
    assertThat(method.params()).isEmpty();
  }
  ...
  protected void validateRecordGetter(MethodStatement method) {
    ...
    assertThat(method.params()).isEmpty();
    assertThat(method.returnType().orElseThrow().actualDeclaration()).isEqualTo("tech.intellispaces.reflection.samples.TestRecord");
  }
