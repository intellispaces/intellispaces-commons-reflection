...
public class ClassTest extends AbstractCustomStatementTest {
  ...
  public void testEmptyClass() {
    ...
    assertThat(classStatement.canonicalName()).isEqualTo("tech.intellispaces.java.reflection.samples.EmptyClass");
    assertThat(classStatement.className()).isEqualTo("tech.intellispaces.java.reflection.samples.EmptyClass");
  ...
  public void testNestedClass() {
    ...
    assertThat(classStatement.canonicalName()).isEqualTo("tech.intellispaces.java.reflection.samples.NestedClass.NestedClass1.NestedClass2");
    assertThat(classStatement.className()).isEqualTo("tech.intellispaces.java.reflection.samples.NestedClass$NestedClass1$NestedClass2");
  }

  @Test
  public void testClassExtendedSuperClassAndImplementedTwoInterfaces() {
    // Given
    final var superClassName = "tech.intellispaces.java.reflection.samples.ClassExtendedSuperClassAndImplementedTwoInterfaces.SuperClass";
    final var interface1Name = "tech.intellispaces.java.reflection.samples.ClassExtendedSuperClassAndImplementedTwoInterfaces.Interface1";
    final var interface2Name = "tech.intellispaces.java.reflection.samples.ClassExtendedSuperClassAndImplementedTwoInterfaces.Interface2";
    ...
    assertThat(classStatement.canonicalName()).isEqualTo("tech.intellispaces.java.reflection.samples.ClassExtendedSuperClassAndImplementedTwoInterfaces.TesteeClass");
    assertThat(classStatement.className()).isEqualTo("tech.intellispaces.java.reflection.samples.ClassExtendedSuperClassAndImplementedTwoInterfaces$TesteeClass");
    ...
    assertThat(classStatement.extendedClass().orElseThrow().actualDeclaration()).isEqualTo("tech.intellispaces.java.reflection.samples.ClassExtendedSuperClassAndImplementedTwoInterfaces.SuperClass");
    assertThat(classStatement.implementedInterfaces().get(0).actualDeclaration()).isEqualTo("tech.intellispaces.java.reflection.samples.ClassExtendedSuperClassAndImplementedTwoInterfaces.Interface1");
    assertThat(classStatement.implementedInterfaces().get(1).actualDeclaration()).isEqualTo("tech.intellispaces.java.reflection.samples.ClassExtendedSuperClassAndImplementedTwoInterfaces.Interface2");
  }

  @Test
  public void testClassWithDefaultConstructor() {
    // Given
    String canonicalClassName = "tech.intellispaces.java.reflection.samples.ClassWithDefaultConstructor";
  ...
  public void testGenericClassWithOneTypeParameter() {
    ...
    // Then
    assertThat(typeReference.actualDeclaration()).isEqualTo("tech.intellispaces.java.reflection.samples.GenericClassWithOneTypeParameter");
  ...
  public void testGenericClassWithCyclicTypeDependencyCase1() {
    ...
    // Then
    assertThat(typeReference.actualDeclaration()).isEqualTo("tech.intellispaces.java.reflection.samples.GenericClassWithCyclicTypeDependencyCase1");
    assertThat(typeReference.formalFullDeclaration()).isEqualTo("GenericClassWithCyclicTypeDependencyCase1<T extends tech.intellispaces.java.reflection.samples.GenericClassWithCyclicTypeDependencyCase1<T>>");
  ...
  public void testGenericClassWithCyclicTypeDependencyCase2() {
    ...
    // Then
    assertThat(typeReference.actualDeclaration()).isEqualTo("tech.intellispaces.java.reflection.samples.GenericClassWithCyclicTypeDependencyCase2.ClassA");
    ...
    ObjectFunctions.handle(classAStatement.typeParameters().get(0), classATypeParam -> {
      ...
      ObjectFunctions.handle(classATypeParam.extendedBounds().get(0).asCustomTypeReference().orElseThrow().targetType(), classBExtendedBound -> {
        assertThat(classBExtendedBound.canonicalName()).isEqualTo("tech.intellispaces.java.reflection.samples.GenericClassWithCyclicTypeDependencyCase2.ClassB");
        assertThat(classBExtendedBound.className()).isEqualTo("tech.intellispaces.java.reflection.samples.GenericClassWithCyclicTypeDependencyCase2$ClassB");
  ...
  private void testClassWithOneMethod(
    ...
    assertThat(classStatement.dependencyTypenames()).containsExactlyInAnyOrderElementsOf(
        CollectionFunctions.join(additionalImports, "tech.intellispaces.java.reflection.support.TesteeType")
    );
  ...
  public void testClassInheritedFromGenericClassAndOneAbstractMethod() {
    ...
    assertThat(declaredMethods.get(0).owner().canonicalName()).isEqualTo(
        "tech.intellispaces.java.reflection.samples.ClassInheritedFromGenericClassAndOneAbstractMethod.ChildClass");
  ...
  public void testClassImplementedInterfaceWithDefaultMethod1() {
    ...
    assertThat(actualMethods.get(0).isAbstract()).isFalse();
    assertThat(actualMethods.get(0).owner().canonicalName()).isEqualTo(
        "tech.intellispaces.java.reflection.samples.ClassImplementedInterfaceWithDefaultMethod1.Interface2");
  }
  ...
  public void testClassImplementedInterfaceWithGenericDefaultMethod1() {
    ...
    assertThat(actualMethods.get(0).owner().canonicalName()).isEqualTo(
        "tech.intellispaces.java.reflection.samples.ClassImplementedInterfaceWithGenericDefaultMethod1.Interface2");
  }
  ...
  public void testClassImplementedInterfaceWithGenericDefaultMethod2() {
    ...
    assertThat(actualMethods.get(0).isDefault()).isTrue();
    assertThat(actualMethods.get(0).owner().canonicalName()).isEqualTo(
        "tech.intellispaces.java.reflection.samples.ClassImplementedInterfaceWithGenericDefaultMethod2.Interface2");
  }
  ...
  public void testClassImplementedInterfaceWithGenericDefaultMethod3() {
    ...
    assertThat(actualMethods.get(0).isDefault()).isTrue();
    assertThat(actualMethods.get(0).owner().canonicalName()).isEqualTo(
        "tech.intellispaces.java.reflection.samples.ClassImplementedInterfaceWithGenericDefaultMethod3.Interface2");
  }
  ...
  public void testClassImplementedInterfaceWithGenericDefaultMethod4() {
    ...
    assertThat(actualMethods.get(0).isDefault()).isTrue();
    assertThat(actualMethods.get(0).owner().canonicalName()).isEqualTo(
        "tech.intellispaces.java.reflection.samples.ClassImplementedInterfaceWithGenericDefaultMethod4.Interface2");
  }
}
