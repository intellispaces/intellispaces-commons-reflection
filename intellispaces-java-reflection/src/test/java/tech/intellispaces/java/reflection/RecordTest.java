...
public class RecordTest extends AbstractCustomStatementTest {
  ...
  public void testEmptyRecord() {
    ...
    assertThat(recordStatement.canonicalName()).isEqualTo("tech.intellispaces.java.reflection.samples.EmptyRecord");
    assertThat(recordStatement.className()).isEqualTo("tech.intellispaces.java.reflection.samples.EmptyRecord");
  ...
  public void testRecordImplementedTwoInterfaces() {
    // Given
    final var interface1Name = "tech.intellispaces.java.reflection.samples.RecordImplementedTwoInterfaces.Interface1";
    final var interface2Name = "tech.intellispaces.java.reflection.samples.RecordImplementedTwoInterfaces.Interface2";
    ...
    assertThat(recordStatement.canonicalName()).isEqualTo("tech.intellispaces.java.reflection.samples.RecordImplementedTwoInterfaces.TesteeRecord");
    assertThat(recordStatement.className()).isEqualTo("tech.intellispaces.java.reflection.samples.RecordImplementedTwoInterfaces$TesteeRecord");
  ...
  public void testGenericRecordWithCyclicTypeDependencyCase2() {
    ...
    ObjectFunctions.handle(recordStatement.typeParameters().get(0), classATypeParam -> {
      ...
      ObjectFunctions.handle(classATypeParam.extendedBounds().get(0).asCustomTypeReference().orElseThrow().targetType(), classBExtendedBound -> {
        assertThat(classBExtendedBound.canonicalName()).isEqualTo("tech.intellispaces.java.reflection.samples.GenericRecordWithCyclicTypeDependencyCase2.RecordB");
        assertThat(classBExtendedBound.className()).isEqualTo("tech.intellispaces.java.reflection.samples.GenericRecordWithCyclicTypeDependencyCase2$RecordB");
  ...
  private void testRecordWithOneMethod(
    ...
    // Given
    String canonicalClassName = "tech.intellispaces.java.reflection.samples." + recordName;
