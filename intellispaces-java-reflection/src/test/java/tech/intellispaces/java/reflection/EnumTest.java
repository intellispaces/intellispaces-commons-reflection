...
public class EnumTest extends AbstractCustomStatementTest {
  ...
  public void testEmptyEnum() {
    ...
    assertThat(enumStatement.canonicalName()).isEqualTo("tech.intellispaces.java.reflection.samples.EmptyEnum");
    assertThat(enumStatement.className()).isEqualTo("tech.intellispaces.java.reflection.samples.EmptyEnum");
  ...
  public void testEnumImplementedTwoInterfaces() {
    // Given
    final var interface1Name = "tech.intellispaces.java.reflection.samples.EnumImplementedTwoInterfaces.Interface1";
    final var interface2Name = "tech.intellispaces.java.reflection.samples.EnumImplementedTwoInterfaces.Interface2";
    ...
    assertThat(enumStatement.canonicalName()).isEqualTo("tech.intellispaces.java.reflection.samples.EnumImplementedTwoInterfaces.TesteeEnum");
    assertThat(enumStatement.className()).isEqualTo("tech.intellispaces.java.reflection.samples.EnumImplementedTwoInterfaces$TesteeEnum");
  ...
  private void testEnumWithOneMethod(
    ...
    // Given
    String enumClassName = "tech.intellispaces.java.reflection.samples." + className;
