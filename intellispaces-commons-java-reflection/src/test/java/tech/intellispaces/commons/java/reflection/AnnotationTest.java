...
import tech.intellispaces.commons.java.reflection.samples.AnnotationWithElementsView;
import tech.intellispaces.commons.java.reflection.samples.TestAnnotation;
...
public class AnnotationTest extends AbstractCustomStatementTest {
  ...
  public void testEmptyAnnotation() {
    ...
    assertThat(annotationStatement.canonicalName()).isEqualTo("tech.intellispaces.commons.java.reflection.samples.EmptyAnnotation");
    assertThat(annotationStatement.className()).isEqualTo("tech.intellispaces.commons.java.reflection.samples.EmptyAnnotation");
  ...
  private void testAnnotationWithElement(String className, String elementMethodName, Consumer<MethodStatement> methodValidator) {
    ...
    assertThat(annotationStatement.dependencyTypenames()).containsExactlyInAnyOrder("tech.intellispaces.commons.java.reflection.support.TesteeType");
  ...
  public void testCyclicAnnotation() {
    ...
    String annotationClassName = "tech.intellispaces.commons.java.reflection.samples.CyclicAnnotations.SomeAnnotation";
