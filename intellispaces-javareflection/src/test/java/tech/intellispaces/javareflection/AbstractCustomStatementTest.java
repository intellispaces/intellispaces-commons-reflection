...
public class AbstractCustomStatementTest {
  ...
  protected void validateEnumGetter(MethodStatement method) {
    ...
    assertThat(method.returnType().orElseThrow().actualDeclaration()).isEqualTo("tech.intellispaces.javareflection.samples.TestEnum");
    assertThat(method.params()).isEmpty();
  }
  ...
  protected void validateRecordGetter(MethodStatement method) {
    ...
    assertThat(method.params()).isEmpty();
    assertThat(method.returnType().orElseThrow().actualDeclaration()).isEqualTo("tech.intellispaces.javareflection.samples.TestRecord");
  }
