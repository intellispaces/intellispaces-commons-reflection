...
import tech.intellispaces.javareflection.samples.AnnotationWithElementsView;
import tech.intellispaces.javareflection.samples.TestAnnotation;
...
public class AnnotationTest extends AbstractCustomStatementTest {
  ...
  public void testEmptyAnnotation() {
    ...
    assertThat(annotationStatement.canonicalName()).isEqualTo("tech.intellispaces.javareflection.samples.EmptyAnnotation");
    assertThat(annotationStatement.className()).isEqualTo("tech.intellispaces.javareflection.samples.EmptyAnnotation");
  ...
  public void testAnnotationWithArrayOfAnnotationElement() {
    testAnnotationWithElement("AnnotationWithArrayOfAnnotationElement", "arrayOfAnnotationElement",
            List.of("tech.intellispaces.javareflection.samples.TestAnnotation"),
            elementMethod -> {
      Assertions.assertThat(elementMethod.returnType().orElseThrow()
          .asArrayReference().orElseThrow()
  ...
  private void testAnnotationWithElement(
    ...
    assertThat(annotationStatement.dependencyTypenames()).containsExactlyInAnyOrderElementsOf(
            CollectionFunctions.join(dependencies, "tech.intellispaces.javareflection.support.TesteeType"));
  ...
  public void testCyclicAnnotation() {
    ...
    String annotationClassName = "tech.intellispaces.javareflection.samples.CyclicAnnotations.SomeAnnotation";
  ...
  public void testAnnotationInstance() {
    ...
    assertThat(annotatedClass.dependencyTypenames()).containsExactlyInAnyOrder(
        "tech.intellispaces.javareflection.support.TesteeType",
        "tech.intellispaces.javareflection.samples.TestEnum",
