...
public class EnumTest extends AbstractCustomStatementTest {
  ...
  public void testEmptyEnum() {
    ...
    assertThat(enumStatement.canonicalName()).isEqualTo("tech.intellispaces.javastatements.samples.EmptyEnum");
    assertThat(enumStatement.className()).isEqualTo("tech.intellispaces.javastatements.samples.EmptyEnum");
    ...
    assertThat(enumStatement.parentTypes().get(0).customType().canonicalName()).isEqualTo(Enum.class.getCanonicalName());
  ...
  public void testEnumImplementedTwoInterfaces() {
    // Given
    final var interface1Name = "tech.intellispaces.javastatements.samples.EnumImplementedTwoInterfaces.Interface1";
    final var interface2Name = "tech.intellispaces.javastatements.samples.EnumImplementedTwoInterfaces.Interface2";
    ...
    assertThat(enumStatement.canonicalName()).isEqualTo("tech.intellispaces.javastatements.samples.EnumImplementedTwoInterfaces.TesteeEnum");
    assertThat(enumStatement.className()).isEqualTo("tech.intellispaces.javastatements.samples.EnumImplementedTwoInterfaces$TesteeEnum");
    ...
    HandleFunctions.handle(enumStatement.parentTypes().get(0), parentType -> {
      assertThat(parentType.customType().canonicalName()).isEqualTo(Enum.class.getCanonicalName());
      assertThat(parentType.typeArguments()).hasSize(1);
      assertThat(parentType.typeArguments().get(0).asCustomType().orElseThrow().customType()).isSameAs(enumStatement);
    });
  ...
  private void testEnumWithOneMethod(
    ...
    // Given
    String enumClassName = "tech.intellispaces.javastatements.samples." + className;
