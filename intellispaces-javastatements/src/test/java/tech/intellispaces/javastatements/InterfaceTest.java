...
public class InterfaceTest extends AbstractCustomStatementTest {
  ...
  public void testEmptyInterface() {
    ...
    assertThat(interfaceStatement.canonicalName()).isEqualTo("tech.intellispaces.javastatements.samples.EmptyInterface");
    assertThat(interfaceStatement.className()).isEqualTo("tech.intellispaces.javastatements.samples.EmptyInterface");
  ...
  public void testNestedInterface() {
    ...
    assertThat(interfaceStatement.canonicalName()).isEqualTo("tech.intellispaces.javastatements.samples.NestedInterface.NestedInterface1.NestedInterface2");
    assertThat(interfaceStatement.className()).isEqualTo("tech.intellispaces.javastatements.samples.NestedInterface$NestedInterface1$NestedInterface2");
  }

  @Test
  public void testInterfaceExtendedTwoInterfaces() {
    // Given
    final var interface1Name = "tech.intellispaces.javastatements.samples.InterfaceExtendedTwoInterfaces.Interface1";
    final var interface2Name = "tech.intellispaces.javastatements.samples.InterfaceExtendedTwoInterfaces.Interface2";
    ...
    assertThat(interfaceStatement.canonicalName()).isEqualTo("tech.intellispaces.javastatements.samples.InterfaceExtendedTwoInterfaces.TesteeInterface");
    assertThat(interfaceStatement.className()).isEqualTo("tech.intellispaces.javastatements.samples.InterfaceExtendedTwoInterfaces$TesteeInterface");
    ...
    HandleFunctions.handle(interfaceStatement.extendedInterfaces().get(0), extendedInterface -> {
      assertThat(extendedInterface.customType().canonicalName()).isEqualTo(interface1Name);
    ...
    HandleFunctions.handle(interfaceStatement.extendedInterfaces().get(1), extendedInterface -> {
      assertThat(extendedInterface.customType().canonicalName()).isEqualTo(interface2Name);
      assertThat(extendedInterface.typeArguments()).isEmpty();
    });
  ...
  public void testGenericInterfaceWithCyclicTypeDependencyCase1() {
    ...
    assertThat(typeReference.customType().typeParametersFullDeclaration()).isEqualTo("<T extends GenericInterfaceWithCyclicTypeDependencyCase1<T>>");
    assertThat(typeReference.customType().typeParametersBriefDeclaration()).isEqualTo("<T>");

    Assertions.assertThat(typeReference.customType().asInterface()).isPresent();
    InterfaceType interfaceStatement = typeReference.customType().asInterface().orElseThrow();
    ...
    HandleFunctions.handle(interfaceStatement.typeParameters().get(0), typeParam -> {
      ...
      assertThat(typeParam.extendedBounds().get(0).asCustomType().orElseThrow().customType()).isSameAs(interfaceStatement);
  ...
  public void testGenericInterfaceWithCyclicTypeDependencyCase2() {
    ...
    assertThat(typeReference.customType().typeParametersFullDeclaration()).isEqualTo("<T1 extends InterfaceB<?>>");
    ...
    HandleFunctions.handle(interfaceStatement.typeParameters().get(0), classATypeParam -> {
      ...
      HandleFunctions.handle(classATypeParam.extendedBounds().get(0).asCustomType().orElseThrow().customType(), classBExtendedBound -> {
        assertThat(classBExtendedBound.canonicalName()).isEqualTo("tech.intellispaces.javastatements.samples.GenericInterfaceWithCyclicTypeDependencyCase2.InterfaceB");
        assertThat(classBExtendedBound.className()).isEqualTo("tech.intellispaces.javastatements.samples.GenericInterfaceWithCyclicTypeDependencyCase2$InterfaceB");
        ...
        assertThat(classBExtendedBound.typeParameters().get(0).asNamed().orElseThrow().extendedBounds().get(0)
            .asCustomType().orElseThrow().customType()).isSameAs(interfaceStatement);
      });
    });
  }
  ...
  private void testInterfaceWithOneMethod(
    ...
    // Given
    String canonicalClassName = "tech.intellispaces.javastatements.samples." + interfaceName;
