...
public class TypesTest {
  ...
  public void testOf_whenBaseTypeOnly() {
    ...
    Assertions.assertThat(stringType.base().asCustomTypeReferenceOrElseThrow().targetType().canonicalName()).isSameAs(String.class.getCanonicalName());
    Assertions.assertThat(integerType.base().asCustomTypeReferenceOrElseThrow().targetType().canonicalName()).isSameAs(Integer.class.getCanonicalName());
    Assertions.assertThat(objectType.base().asCustomTypeReferenceOrElseThrow().targetType().canonicalName()).isSameAs(Object.class.getCanonicalName());
  }
  ...
  public void testOf_whenList() {
    ...
    Assertions.assertThat(listType.base().asCustomTypeReferenceOrElseThrow().targetType().canonicalName()).isSameAs(List.class.getCanonicalName());
