...
public class ClassTest extends AbstractCustomStatementTest {
  ...
  public void testClassExtendedSuperClassAndImplementedTwoInterfaces() {
    ...
    HandleFunctions.handle(classStatement.extendedClass().orElseThrow(), extendedClass -> {
      assertThat(extendedClass.customType().canonicalName()).isEqualTo(superClassName);
    ...
    HandleFunctions.handle(classStatement.parentTypes().get(0), parentType -> {
      assertThat(parentType.customType().canonicalName()).isEqualTo(superClassName);
  ...
  public void testGenericClassWithOneTypeParameter() {
    ...
    assertThat(typeReference.customType().typeParametersFullDeclaration()).isEqualTo("<T>");
    assertThat(typeReference.customType().typeParametersBriefDeclaration()).isEqualTo("<T>");

    Assertions.assertThat(typeReference.customType().asClass()).isPresent();
    ClassType classStatement = typeReference.customType().asClass().orElseThrow();
  ...
  public void testGenericClassWithMultipleTypeParameters() {
    ...
    assertThat(typeReference.customType().typeParametersFullDeclaration()).isEqualTo("<T1, T2 extends T1, T3 extends Number, T4 extends AutoCloseable & DataInput>");
    assertThat(typeReference.customType().typeParametersBriefDeclaration()).isEqualTo("<T1, T2, T3, T4>");
    ...
    HandleFunctions.handle(classStatement.typeParameters().get(2), typeParam -> {
      ...
      assertThat(typeParam.extendedBounds()).hasSize(1);
      assertThat(typeParam.extendedBounds().get(0).asCustomType().orElseThrow().customType().canonicalName()).isEqualTo(Number.class.getCanonicalName());
    ...
    HandleFunctions.handle(classStatement.typeParameters().get(3), typeParam -> {
      ...
      assertThat(typeParam.extendedBounds().get(0).asCustomType().orElseThrow().customType().canonicalName()).isEqualTo(AutoCloseable.class.getCanonicalName());
      assertThat(typeParam.extendedBounds().get(1).asCustomType().orElseThrow().customType().canonicalName()).isEqualTo(DataInput.class.getCanonicalName());
  ...
  public void testGenericClassWithCyclicTypeDependencyCase1() {
    ...
    HandleFunctions.handle(classStatement.typeParameters().get(0), typeParam -> {
      assertThat(typeParam.name()).isEqualTo("T");
      assertThat(typeParam.extendedBounds()).hasSize(1);
      assertThat(typeParam.extendedBounds().get(0).asCustomType().orElseThrow().customType()).isSameAs(classStatement);
  ...
  public void testGenericClassWithCyclicTypeDependencyCase2() {
    ...
    assertThat(typeReference.customType().typeParametersFullDeclaration()).isEqualTo("<T1 extends ClassB<?>>");
    assertThat(typeReference.customType().typeParametersBriefDeclaration()).isEqualTo("<T1>");

    Assertions.assertThat(typeReference.customType().asClass()).isPresent();
    ClassType classAStatement = typeReference.customType().asClass().orElseThrow();
    ...
    HandleFunctions.handle(classAStatement.typeParameters().get(0), classATypeParam -> {
      ...
      HandleFunctions.handle(classATypeParam.extendedBounds().get(0).asCustomType().orElseThrow().customType(), classBExtendedBound -> {
        ...
        assertThat(classBExtendedBound.typeParameters().get(0).asNamed().orElseThrow().extendedBounds().get(0)
            .asCustomType().orElseThrow().customType()).isSameAs(classAStatement);
      });
    });
  }
