...
public class InterfaceTest extends AbstractCustomStatementTest {
  ...
  public void testEmptyInterface() {
    ...
    assertThat(interfaceStatement.canonicalName()).isEqualTo("intellispaces.common.javastatements.samples.EmptyInterface");
    assertThat(interfaceStatement.className()).isEqualTo("intellispaces.common.javastatements.samples.EmptyInterface");
  ...
  public void testNestedInterface() {
    ...
    assertThat(interfaceStatement.canonicalName()).isEqualTo("intellispaces.common.javastatements.samples.NestedInterface.NestedInterface1.NestedInterface2");
    assertThat(interfaceStatement.className()).isEqualTo("intellispaces.common.javastatements.samples.NestedInterface$NestedInterface1$NestedInterface2");
  }

  @Test
  public void testInterfaceExtendedTwoInterfaces() {
    // Given
    final var interface1Name = "intellispaces.common.javastatements.samples.InterfaceExtendedTwoInterfaces.Interface1";
    final var interface2Name = "intellispaces.common.javastatements.samples.InterfaceExtendedTwoInterfaces.Interface2";
    ...
    assertThat(interfaceStatement.canonicalName()).isEqualTo("intellispaces.common.javastatements.samples.InterfaceExtendedTwoInterfaces.TesteeInterface");
    assertThat(interfaceStatement.className()).isEqualTo("intellispaces.common.javastatements.samples.InterfaceExtendedTwoInterfaces$TesteeInterface");
  ...
  public void testGenericInterfaceWithCyclicTypeDependencyCase2() {
    ...
    HandleFunctions.handle(interfaceStatement.typeParameters().get(0), classATypeParam -> {
      ...
      HandleFunctions.handle(classATypeParam.extendedBounds().get(0).asCustomTypeReference().orElseThrow().targetType(), classBExtendedBound -> {
        assertThat(classBExtendedBound.canonicalName()).isEqualTo("intellispaces.common.javastatements.samples.GenericInterfaceWithCyclicTypeDependencyCase2.InterfaceB");
        assertThat(classBExtendedBound.className()).isEqualTo("intellispaces.common.javastatements.samples.GenericInterfaceWithCyclicTypeDependencyCase2$InterfaceB");
  ...
  private void testInterfaceWithOneMethod(
    ...
    // Given
    String canonicalClassName = "intellispaces.common.javastatements.samples." + interfaceName;
