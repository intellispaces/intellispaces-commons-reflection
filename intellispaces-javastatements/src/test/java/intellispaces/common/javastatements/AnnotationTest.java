...
import intellispaces.common.javastatements.reference.PrimitiveReferences;
import intellispaces.common.javastatements.samples.AnnotationWithElementsView;
...
public class AnnotationTest extends AbstractCustomStatementTest {
  ...
  public void testEmptyAnnotation() {
    ...
    assertThat(annotationStatement.canonicalName()).isEqualTo("intellispaces.common.javastatements.samples.EmptyAnnotation");
    assertThat(annotationStatement.className()).isEqualTo("intellispaces.common.javastatements.samples.EmptyAnnotation");
  ...
  private void testAnnotationWithElement(String className, String elementMethodName, Consumer<MethodStatement> methodValidator) {
    ...
    assertThat(annotationStatement.dependencyTypenames()).containsExactlyInAnyOrder("intellispaces.common.javastatements.support.TesteeType");
  ...
  public void testCyclicAnnotation() {
    ...
    String annotationClassName = "intellispaces.common.javastatements.samples.CyclicAnnotations.SomeAnnotation";
