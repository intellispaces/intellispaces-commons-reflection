...
import intellispaces.common.datahandle.HandleFunctions;
...
public class ClassTest extends AbstractCustomStatementTest {
  ...
  public void testEmptyClass() {
    ...
    assertThat(classStatement.canonicalName()).isEqualTo("intellispaces.common.javastatements.samples.EmptyClass");
    assertThat(classStatement.className()).isEqualTo("intellispaces.common.javastatements.samples.EmptyClass");
    ...
    assertThat(classStatement.dependencyTypenames()).containsExactlyInAnyOrder(
        "intellispaces.common.javastatements.support.TesteeType"
    );
  }
  ...
  public void testNestedClass() {
    ...
    assertThat(classStatement.canonicalName()).isEqualTo("intellispaces.common.javastatements.samples.NestedClass.NestedClass1.NestedClass2");
    assertThat(classStatement.className()).isEqualTo("intellispaces.common.javastatements.samples.NestedClass$NestedClass1$NestedClass2");
  }

  @Test
  public void testClassExtendedSuperClassAndImplementedTwoInterfaces() {
    // Given
    final var superClassName = "intellispaces.common.javastatements.samples.ClassExtendedSuperClassAndImplementedTwoInterfaces.SuperClass";
    final var interface1Name = "intellispaces.common.javastatements.samples.ClassExtendedSuperClassAndImplementedTwoInterfaces.Interface1";
    final var interface2Name = "intellispaces.common.javastatements.samples.ClassExtendedSuperClassAndImplementedTwoInterfaces.Interface2";
    ...
    assertThat(classStatement.canonicalName()).isEqualTo("intellispaces.common.javastatements.samples.ClassExtendedSuperClassAndImplementedTwoInterfaces.TesteeClass");
    assertThat(classStatement.className()).isEqualTo("intellispaces.common.javastatements.samples.ClassExtendedSuperClassAndImplementedTwoInterfaces$TesteeClass");
  ...
  public void testClassWithDefaultConstructor() {
    // Given
    String canonicalClassName = "intellispaces.common.javastatements.samples.ClassWithDefaultConstructor";
  ...
  public void testGenericClassWithCyclicTypeDependencyCase2() {
    ...
    HandleFunctions.handle(classAStatement.typeParameters().get(0), classATypeParam -> {
      ...
      HandleFunctions.handle(classATypeParam.extendedBounds().get(0).asCustomTypeReference().orElseThrow().targetType(), classBExtendedBound -> {
        assertThat(classBExtendedBound.canonicalName()).isEqualTo("intellispaces.common.javastatements.samples.GenericClassWithCyclicTypeDependencyCase2.ClassB");
        assertThat(classBExtendedBound.className()).isEqualTo("intellispaces.common.javastatements.samples.GenericClassWithCyclicTypeDependencyCase2$ClassB");
  ...
  private void testClassWithOneMethod(
    ...
    // Given
    String canonicalClassName = "intellispaces.common.javastatements.samples." + className;
    ...
    assertThat(classStatement.dependencyTypenames()).containsExactlyInAnyOrderElementsOf(
        CollectionFunctions.join(additionalImports, "intellispaces.common.javastatements.support.TesteeType")
    );
