...
public class EnumTest extends AbstractCustomStatementTest {
  ...
  public void testEmptyEnum() {
    ...
    assertThat(enumStatement.canonicalName()).isEqualTo("intellispaces.common.javastatements.samples.EmptyEnum");
    assertThat(enumStatement.className()).isEqualTo("intellispaces.common.javastatements.samples.EmptyEnum");
  ...
  public void testEnumImplementedTwoInterfaces() {
    // Given
    final var interface1Name = "intellispaces.common.javastatements.samples.EnumImplementedTwoInterfaces.Interface1";
    final var interface2Name = "intellispaces.common.javastatements.samples.EnumImplementedTwoInterfaces.Interface2";
    ...
    assertThat(enumStatement.canonicalName()).isEqualTo("intellispaces.common.javastatements.samples.EnumImplementedTwoInterfaces.TesteeEnum");
    assertThat(enumStatement.className()).isEqualTo("intellispaces.common.javastatements.samples.EnumImplementedTwoInterfaces$TesteeEnum");
  ...
  private void testEnumWithOneMethod(
    ...
    // Given
    String enumClassName = "intellispaces.common.javastatements.samples." + className;
