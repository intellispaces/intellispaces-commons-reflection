...
public class RecordTest extends AbstractCustomStatementTest {
  ...
  public void testEmptyRecord() {
    ...
    assertThat(recordStatement.canonicalName()).isEqualTo("intellispaces.common.javastatements.samples.EmptyRecord");
    assertThat(recordStatement.className()).isEqualTo("intellispaces.common.javastatements.samples.EmptyRecord");
  ...
  public void testRecordImplementedTwoInterfaces() {
    // Given
    final var interface1Name = "intellispaces.common.javastatements.samples.RecordImplementedTwoInterfaces.Interface1";
    final var interface2Name = "intellispaces.common.javastatements.samples.RecordImplementedTwoInterfaces.Interface2";
    ...
    assertThat(recordStatement.canonicalName()).isEqualTo("intellispaces.common.javastatements.samples.RecordImplementedTwoInterfaces.TesteeRecord");
    assertThat(recordStatement.className()).isEqualTo("intellispaces.common.javastatements.samples.RecordImplementedTwoInterfaces$TesteeRecord");
  ...
  public void testGenericRecordWithCyclicTypeDependencyCase2() {
    ...
    HandleFunctions.handle(recordStatement.typeParameters().get(0), classATypeParam -> {
      ...
      HandleFunctions.handle(classATypeParam.extendedBounds().get(0).asCustomTypeReference().orElseThrow().targetType(), classBExtendedBound -> {
        assertThat(classBExtendedBound.canonicalName()).isEqualTo("intellispaces.common.javastatements.samples.GenericRecordWithCyclicTypeDependencyCase2.RecordB");
        assertThat(classBExtendedBound.className()).isEqualTo("intellispaces.common.javastatements.samples.GenericRecordWithCyclicTypeDependencyCase2$RecordB");
  ...
  private void testRecordWithOneMethod(
    ...
    // Given
    String canonicalClassName = "intellispaces.common.javastatements.samples." + recordName;
