...
public class RecordTest extends AbstractCustomStatementTest {
  ...
  public void testEmptyRecord() {
    ...
    assertThat(recordStatement.canonicalName()).isEqualTo("intellispaces.javastatements.samples.EmptyRecord");
    assertThat(recordStatement.className()).isEqualTo("intellispaces.javastatements.samples.EmptyRecord");
  ...
  public void testRecordImplementedTwoInterfaces() {
    // Given
    final var interface1Name = "intellispaces.javastatements.samples.RecordImplementedTwoInterfaces.Interface1";
    final var interface2Name = "intellispaces.javastatements.samples.RecordImplementedTwoInterfaces.Interface2";
    ...
    assertThat(recordStatement.canonicalName()).isEqualTo("intellispaces.javastatements.samples.RecordImplementedTwoInterfaces.TesteeRecord");
    assertThat(recordStatement.className()).isEqualTo("intellispaces.javastatements.samples.RecordImplementedTwoInterfaces$TesteeRecord");
  ...
  public void testGenericRecordWithCyclicTypeDependencyCase2() {
    ...
    HandleFunctions.handle(recordStatement.typeParameters().get(0), classATypeParam -> {
      ...
      HandleFunctions.handle(classATypeParam.extendedBounds().get(0).asCustomTypeReference().orElseThrow().targetType(), classBExtendedBound -> {
        assertThat(classBExtendedBound.canonicalName()).isEqualTo("intellispaces.javastatements.samples.GenericRecordWithCyclicTypeDependencyCase2.RecordB");
        assertThat(classBExtendedBound.className()).isEqualTo("intellispaces.javastatements.samples.GenericRecordWithCyclicTypeDependencyCase2$RecordB");
  ...
  private void testRecordWithOneMethod(
    ...
    // Given
    String canonicalClassName = "intellispaces.javastatements.samples." + recordName;
