...
public class EnumTest extends AbstractCustomStatementTest {
  ...
  public void testEmptyEnum() {
    ...
    assertThat(enumStatement.canonicalName()).isEqualTo("intellispaces.javastatements.samples.EmptyEnum");
    assertThat(enumStatement.className()).isEqualTo("intellispaces.javastatements.samples.EmptyEnum");
  ...
  public void testEnumImplementedTwoInterfaces() {
    // Given
    final var interface1Name = "intellispaces.javastatements.samples.EnumImplementedTwoInterfaces.Interface1";
    final var interface2Name = "intellispaces.javastatements.samples.EnumImplementedTwoInterfaces.Interface2";
    ...
    assertThat(enumStatement.canonicalName()).isEqualTo("intellispaces.javastatements.samples.EnumImplementedTwoInterfaces.TesteeEnum");
    assertThat(enumStatement.className()).isEqualTo("intellispaces.javastatements.samples.EnumImplementedTwoInterfaces$TesteeEnum");
  ...
  private void testEnumWithOneMethod(
    ...
    // Given
    String enumClassName = "intellispaces.javastatements.samples." + className;
