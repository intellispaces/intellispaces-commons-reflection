...
public class ClassTest extends AbstractCustomStatementTest {
  ...
  public void testEmptyClass() {
    ...
    assertThat(classStatement.canonicalName()).isEqualTo("intellispaces.javastatements.samples.EmptyClass");
    assertThat(classStatement.className()).isEqualTo("intellispaces.javastatements.samples.EmptyClass");
  ...
  public void testNestedClass() {
    ...
    assertThat(classStatement.canonicalName()).isEqualTo("intellispaces.javastatements.samples.NestedClass.NestedClass1.NestedClass2");
    assertThat(classStatement.className()).isEqualTo("intellispaces.javastatements.samples.NestedClass$NestedClass1$NestedClass2");
  }

  @Test
  public void testClassExtendedSuperClassAndImplementedTwoInterfaces() {
    // Given
    final var superClassName = "intellispaces.javastatements.samples.ClassExtendedSuperClassAndImplementedTwoInterfaces.SuperClass";
    final var interface1Name = "intellispaces.javastatements.samples.ClassExtendedSuperClassAndImplementedTwoInterfaces.Interface1";
    final var interface2Name = "intellispaces.javastatements.samples.ClassExtendedSuperClassAndImplementedTwoInterfaces.Interface2";
    ...
    assertThat(classStatement.canonicalName()).isEqualTo("intellispaces.javastatements.samples.ClassExtendedSuperClassAndImplementedTwoInterfaces.TesteeClass");
    assertThat(classStatement.className()).isEqualTo("intellispaces.javastatements.samples.ClassExtendedSuperClassAndImplementedTwoInterfaces$TesteeClass");
  ...
  public void testClassWithDefaultConstructor() {
    // Given
    String canonicalClassName = "intellispaces.javastatements.samples.ClassWithDefaultConstructor";
  ...
  public void testGenericClassWithCyclicTypeDependencyCase2() {
    ...
    HandleFunctions.handle(classAStatement.typeParameters().get(0), classATypeParam -> {
      ...
      HandleFunctions.handle(classATypeParam.extendedBounds().get(0).asCustomTypeReference().orElseThrow().targetType(), classBExtendedBound -> {
        assertThat(classBExtendedBound.canonicalName()).isEqualTo("intellispaces.javastatements.samples.GenericClassWithCyclicTypeDependencyCase2.ClassB");
        assertThat(classBExtendedBound.className()).isEqualTo("intellispaces.javastatements.samples.GenericClassWithCyclicTypeDependencyCase2$ClassB");
