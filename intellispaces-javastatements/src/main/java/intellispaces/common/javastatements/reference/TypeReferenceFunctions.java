...
import intellispaces.common.javastatements.customtype.CustomTypeFunctions;
...
public interface TypeReferenceFunctions {
  ...
  private static String getActualTypeDeclaration(TypeReference typeReference, boolean blind) {
    return getActualTypeDeclaration(typeReference, blind, intellispaces.common.type.TypeFunctions::getSimpleName);
}

  static String getSimpleTypeDeclaration(TypeReference typeReference) {
    return getSimpleTypeDeclaration(typeReference, intellispaces.common.type.TypeFunctions::getSimpleName);
  }
