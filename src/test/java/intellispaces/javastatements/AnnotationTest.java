...
import intellispaces.javastatements.sample.AnnotationWithElementsView;
import intellispaces.javastatements.sample.TestAnnotation;
...
/**
 * Tests for {@link intellispaces.javastatements.model.custom.AnnotationStatement}.
 */
public class AnnotationTest extends AbstractCustomTypeTest {
  ...
  public void testEmptyAnnotation() {
    ...
    assertThat(annotationStatement.canonicalName()).isEqualTo("intellispaces.javastatements.sample.EmptyAnnotation");
    ...
    CommonFunctions.handle(annotationStatement.annotations().get(0), annInstance -> {
  ...
  public void testAnnotationWithArrayOfAnnotationDefaultElement() {
    testAnnotationWithElement("AnnotationWithArrayOfAnnotationDefaultElement", "arrayOfAnnotationElementDefault", elementMethod -> {
      ...
      assertThat(elementMethod.defaultValue().orElseThrow()
          .asArray().orElseThrow()
          .elementType().asCustomTypeReference().orElseThrow().targetType().canonicalName()).isEqualTo(TestAnnotation.class.getCanonicalName());
      CommonFunctions.handle(elementMethod.defaultValue().orElseThrow().asArray().orElseThrow().elements(), elements -> {
  ...
  private void testAnnotationWithElement(String className, String elementMethodName, HandlerAction<MethodStatement> methodValidator) {
    // Given
  ...
  public void testCyclicAnnotation() {
    ...
    String annotationClassName = "intellispaces.javastatements.sample.CyclicAnnotations.SomeAnnotation";
